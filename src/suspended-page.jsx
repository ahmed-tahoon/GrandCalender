  ...
  return (
      <main className="min-h-[100vh] grid place-items-center bg-white py-24 px-6 sm:py-32 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-base font-semibold text-grandkit-600">Sorry, you has been suspended.</p>
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a href={"mailto:"+import.meta.env.VITE_APP_DOMAIN} className="text-sm font-semibold text-gray-900">
