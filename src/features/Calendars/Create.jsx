...
export default function CalendarsCreate() {
    ...
    const sendData = (values) =>
        new Promise((resolve, reject) => {
            ...
            if (values.time_slots_intervals) {
                formData.append("duration", durationMinutes(values));

                if (values.duration.id === "custom") {
                    formData.append(
                        "duration_type",
    ...
    return (
        ...
        >
            <Form
                ...
                onSubmit={onSubmit}
                initialValues={{
                    availability: user.default_availability,
                        ...
                        >
                            <div className="rounded-lg bg-white shadow">
                                <div className="p-6">
                                    ...
                                    {/* Alert message you not have any availability set up. add button "create one" */}
                                    {!user.default_availability && (
