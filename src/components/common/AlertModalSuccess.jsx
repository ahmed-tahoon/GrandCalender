...
export default function AlertModalSuccess(props) {
  const { open, confirm, close, confirmButtonText, note, title, importantNote } = props
            ...
            >
              <Dialog.Panel className="relative bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full sm:p-6">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        { note ? note : 'Are you sure you want to do this? This action cannot be undone.' }
                      </p>
                ...
                <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                  <button
                    type="button"
                    className="mt-3 w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-grandkit-600 text-base font-medium text-white hover:bg-grandkit-700 focus:outline-none focus:ring-0 sm:ml-3 sm:w-auto sm:text-sm"
