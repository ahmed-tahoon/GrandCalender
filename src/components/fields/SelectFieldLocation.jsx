...
export default function SelectFieldLocation(props) {
    ...
    function handleChange(value) {
        input.onChange(value.kind)
        setSelectedOption(value.kind)
    }
        ...
        <div className={'sm:col-span-'+col}>
            ...
            <div className="mt-1 relative rounded-md shadow-sm">
                <Select
                    ...
                    defaultValue={updatedOptions.find(option => option.kind === selectedOption)}
