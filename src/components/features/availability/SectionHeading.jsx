...
export default function SectionHeading({user}) {
  return (
    <div className="border-b border-gray-200 pb-5 sm:flex sm:items-center sm:justify-between">
        <h3 className="text-lg font-medium leading-6 text-gray-900 uppercase">Availabilities</h3>
        <div className="mt-3 sm:mt-0 sm:ml-4">
            ...
            <div className="relative flex-grow focus-within:z-10">
                ...
                className="block w-full rounded-none rounded-l-md border-gray-300 pl-10 focus:border-grandkit-500 focus:ring-grandkit-500 sm:hidden"
                placeholder="Search"
                />
                <input
                type="text"
                ...
                className="hidden w-full rounded-none rounded-l-md border-gray-300 pl-10 focus:border-grandkit-500 focus:ring-grandkit-500 sm:block sm:text-sm"
        ...
        <Link
            to="/dashboard/availability/create"
