...
export default function Login() {
    ...
    // Update email input if query string is exist
    useEffect(() => {
        ...
        <AuthenticationLayout>
            <div>
                ...
                <p className="mt-2 text-sm text-gray-600">
                    Or{' '}
                    <Link to="/register" className="font-medium text-grandkit-600 hover:text-grandkit-500">
                        Sign up for free
                    </Link>
                </p>
            </div>
                ...
                <div className="mt-6">
                    <div className="space-y-6">
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="mt-1">
                                <input placeholder="Enter password here" onChange={(e) => setPassword(e.target.value)} id="password" name="password" type="password" autoComplete="current-password" required
                                    className="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-grandkit-500 focus:outline-none focus:ring-grandkit-500 sm:text-sm" />
                            </div>
                        </div>
                        ...
                        <div>
                            <button onClick={login} disabled={!email || !password || signinButtonDisabled} type="submit"
