...
export default function OrdersBillings() {
                        ...
                        <div className="overflow-hidden border-t border-gray-200">
                            ...
                            <tbody className="divide-y divide-gray-200 bg-white">
                                {transactions.map((transaction) => (<tr key={transaction.id}>
                                    ...
                                    <td className="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                                        <Link to={'/dashboard/orders-billings/'+transaction.id} className="mr-4 text-grandkit-600 hover:text-grandkit-700">
                                            Details
                                        </Link>
                                    </td>
                                </tr>))}
                          ...
                          {/* Pagination */}
                            ...
                            {(transactions.length === 0 && isLoaded) && (<div className="text-center mb-6">
                                ...
                                <h3 className="mt-2 text-sm font-medium text-gray-900">No receipt</h3>
                                <p className="mt-1 text-sm text-gray-500">Get started by upgrading to a plan</p>
                                <div className="mt-6">
